...
// ●Window_SrpgStatus
//====================================================================
	//modified by onlimono, 적군 또는 턴종료 아군 클릭시 보여지는 윈도우
    ...
    Window_SrpgStatus.prototype.windowWidth = function() {
        return Graphics.boxWidth / 2; //408;
    };

    Window_SrpgStatus.prototype.windowHeight = function() {
        return this.fittingHeight(3); //10);
    };
...
//====================================================================
    //modified by onlimono, 아군 조종시 보이는 윈도우
...
//====================================================================
    //modified by onlimono, 전투 화면의 윈도우
...
//====================================================================
    //modified by onlimono, 전투 결과 나오는 윈도우
    ...
    Window_SrpgBattleResult.prototype.drawContents = function() {
        var lineHeight = this.lineHeight();
        this.drawGainExp(0, lineHeight * 0); //6, lineHeight * 0);
        this.drawGainGold(0, lineHeight * 1); //6, lineHeight * 2);
        this.drawGainItem(0, lineHeight * 2); //0, lineHeight * 3);
    };
...
*/
        ...
        var expNext = TextManager.expNext.format(TextManager.level);
        this.drawText(expNext, x + 100, y, 270);
